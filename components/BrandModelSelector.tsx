...
export default function BrandModelSelector({ productName, productCode, productImage = null, models }: { productName: string; productCode: string; productImage?: string | null; models: PowerToolModel[] }) {
