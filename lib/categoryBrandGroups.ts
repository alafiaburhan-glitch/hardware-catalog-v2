...
export const categoryBrandGroups: Record<string, CategoryBrand[]> = {
  ...
  "hand-tools": [
    ...
    },
    {
      ...
      matchTerms: ["socket", "allen key", "ratchet handle", "rachet handle", "ht-socket"],
    },
    {
      name: "Screwdrivers",
      slug: "screwdrivers",
    ...
    },
    {
      ...
      description: "Hacksaws, chisels, punches, tile cutters, threading tools and surface-finishing accessories.",
      image: "/products/hand-tools/animated/hacksaw-frame-and-blade.png",
      matchTerms: ["hacksaw", "chisel", "punch", "tile cutter", "cutting & drill", "pvc pipe", "snap-off", "steel files", "hole saw", "abrasive wheels", "screw extractor", "thread die", "sanding kit", "wire brush", "ht-cut"],
    },
    {
    ...
    },
    {
      ...
      matchTerms: ["vernier", "measuring", "try square", "steel rule", "calipers", "spring dividers", "plumbob", "tyre gauge", "tyre guage", "ht-measure"],
    },
    {
      name: "Lubrication & Spray Tools",
      slug: "lubrication-spray-tools",
      description: "Grease guns, oil cans, spray guns and pressure-washing accessories.",
      image: "/products/hand-tools/animated/grease-gun-and-oil-can.png",
      matchTerms: ["grease gun", "oil can", "spray", "air gun", "pressure washer", "foam cannon", "ht-spray"],
    },
    {
      name: "Automotive & Lifting Tools",
      slug: "automotive-lifting-tools",
      description: "Hydraulic jacks, tyre-service equipment and automotive workshop tools.",
      image: "/products/hand-tools/animated/hydraulic-jack-and-jack-stand.png",
      matchTerms: ["hydraulic jack", "jack stand", "towing rope", "mini air compressor", "air chuck", "piston compression", "tyre repair kit", "tyre lever", "ht-lift"],
    },
    {
      ...
      matchTerms: ["masonry", "putty", "scraper", "karandi", "sponge", "ht-mason"],
    },
    {
      name: "Garden Tools",
      slug: "garden-tools",
      description: "Pruning, shearing, cultivating, digging and general garden hand tools.",
      image: "/products/hand-tools/animated/garden-tool-set.png",
      matchTerms: ["garden", "hedge", "bill hook", "pruning", "angle shear", "manvetti", "mamootie", "crowbar", "wrecking bar", "satti", "wooden handle size baby", "ht-garden"],
    },
    {
    ...
    {
      name: "Electrical, Soldering & Testing",
      slug: "electrical-soldering-testing",
      description: "Soldering irons, gas torches, work lights and electrical test instruments.",
      image: "/products/hand-tools/animated/multimeter.png",
      matchTerms: ["soldering", "butane burner", "butane gas torch", "working light", "multimeter"],
    },
    {
      name: "Material Handling & Rigging Tools",
      slug: "material-handling-rigging",
      description: "Chains, workshop pulleys and manual strapping tensioners.",
      image: "/products/hand-tools/animated/chains.png",
      matchTerms: ["chains", "pulleys", "well pulley", "strapping tensioner"],
    },
    {
      name: "Plumbing & Pipe Accessories",
      slug: "plumbing-pipe-accessories",
      description: "Pipe-working tools and specialist plumbing accessories.",
      image: "/products/hand-tools/animated/pipe-wrench.png",
      matchTerms: ["pvc tap adaptor"],
    },
  ],
  "industrial-adhesives-sealants": [
    ...
    },
    {
      name: "ABRO",
      slug: "abro",
      description: "ABRO specialist adhesives, sealants, PU foam and repair products.",
    ...
    },
    {
      name: "Dendrite",
      slug: "dendrite",
      description: "Dendrite contact adhesives and specialist bonding products.",
      image: "/products/web-catalog/dendrite-pc-65.webp",
      matchTerms: ["dendrite", "den-"],
    },
    {
      name: "DKLOG",
      slug: "dklog",
      description: "D-klog drain-cleaning compound for clearing clogged drain pipes.",
      image: "/products/web-catalog/dklog.webp",
      matchTerms: ["dklog", "dkl-"],
    },
    {
      name: "Holdite",
      slug: "holdite",
      description: "Holdite industrial sealing, bonding and repair products.",
      image: "/products/web-catalog/holdtite-pvc-solvent.jpg",
      matchTerms: ["holdite", "hol-"],
    },
  ],
};
